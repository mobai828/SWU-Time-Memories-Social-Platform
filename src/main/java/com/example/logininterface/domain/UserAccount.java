...
public class UserAccount {
    ...
    @Column(name = "last_profile_update_date")
    private java.time.LocalDate lastProfileUpdateDate;
    ...
    public java.time.LocalDate getLastProfileUpdateDate() {
        return lastProfileUpdateDate;
    }

    public void setLastProfileUpdateDate(java.time.LocalDate lastProfileUpdateDate) {
        this.lastProfileUpdateDate = lastProfileUpdateDate;
    }

    public int getDailyProfileUpdateCount() {
        return dailyProfileUpdateCount;
    }
